...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vdly__sinegen__DOT__addr = vlSelfRef.sinegen__DOT__addr;
    if (vlSelfRef.rst) {
        vlSelfRef.__Vdly__sinegen__DOT__addr = 0U;
    } else if (vlSelfRef.en) {
        vlSelfRef.__Vdly__sinegen__DOT__addr = (0xffU 
...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__1(Vsinegen___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.dout = vlSelfRef.sinegen__DOT__myRom__DOT__rom_array
        [vlSelfRef.sinegen__DOT__addr];
    if (((0U < ((IData)(vlSelfRef.sinegen__DOT__addr) 
                + (IData)(vlSelfRef.phase))) & (0x100U 
                                                > ((IData)(vlSelfRef.sinegen__DOT__addr) 
                                                   + (IData)(vlSelfRef.phase))))) {
        vlSelfRef.dout2 = vlSelfRef.sinegen__DOT__myRom2__DOT__rom_array
            [(0xffU & ((IData)(vlSelfRef.sinegen__DOT__addr) 
                       + (IData)(vlSelfRef.phase)))];
    }
}
...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__2(Vsinegen___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.sinegen__DOT__addr = vlSelfRef.__Vdly__sinegen__DOT__addr;
}
...
void Vsinegen___024root___eval_debug_assertions(Vsinegen___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__pinNumber8 & 0xfeU))) {
