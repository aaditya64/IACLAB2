...
VL_ATTR_COLD void Vsinegen___024root___eval_initial__TOP(Vsinegen___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 256, 0, VL_CVT_PACK_STR_NW(3, __Vtemp_1)
                 ,  &(vlSelfRef.sinegen__DOT__myRom__DOT__rom_array)
                 , 0, ~0ULL);
    VL_WRITEF_NX("Loading rom.\n",0);
    __Vtemp_2[0U] = 0x2e6d656dU;
    __Vtemp_2[1U] = 0x65726f6dU;
    __Vtemp_2[2U] = 0x73696eU;
    VL_READMEM_N(true, 8, 256, 0, VL_CVT_PACK_STR_NW(3, __Vtemp_2)
                 ,  &(vlSelfRef.sinegen__DOT__myRom2__DOT__rom_array)
                 , 0, ~0ULL);
}
...
VL_ATTR_COLD void Vsinegen___024root___ctor_var_reset(Vsinegen___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->sinegen__DOT__myRom2__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }
